      ...
      <main className="main-content">
        <header className="top-header">
          <div className="page-heading">
            ...
            <p>
              Review requests from buyers for your rental cars.
            </p>
          </div>
        </header>
                  ...
                  <tr>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() =>
                          viewDetails(request._id)
                        }
                      >
                        {detail?._id === request._id
                          ? 'Hide Details'
                          : 'Details'}
                      </button>
