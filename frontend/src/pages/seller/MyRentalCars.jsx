...
export default function MyRentalCars() {
  ...
  const remove = async (id) => {
    if (confirm('Delete this rental listing?')) {
      ...
      <main className="main-content">
        <header className="top-header">
          <div className="page-heading">
            ...
            <p>
              Manage rental vehicles separately from sale listings.
            </p>
          </div>

          <Link
            className="add-btn"
            to="/seller/rental-cars/add"
          >
            + Add Rental Car
          </Link>
        </header>
            ...
            <tbody>
              ...
              {rentals.map((rental) => (
                <tr key={rental._id}>
                  ...
                  <td>
                    <span
                      className={`status-pill rental-status ${rental.status}`}
                    >
                      {rental.status}
                    </span>
                  </td>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() =>
                        navigate(
                          `/seller/rental-cars/add?edit=${rental._id}`
                        )
                      }
                    >
                      Edit
