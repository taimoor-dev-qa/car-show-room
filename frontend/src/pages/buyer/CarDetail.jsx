  ...
  return (
    <div className="car-detail-wrapper">
      ...
      <div className="detail-image-wrap">
        {images.length ? (
          <img
            src={`http://localhost:3500/uploads/${images[activeImage]}`}
            alt={car.makeModel}
          />
        ) : (
          <div className="detail-image-placeholder">
            {emojiMap[car.category] || 'Car'}
          </div>
        )}
      </div>
      ...
      <div className="detail-title-row">
        <div>
          ...
          {car.isNegotiable && (
            <span className="detail-negotiable-badge">
              Negotiable
            </span>
          )}
        </div>
      ...
      <section className="detail-description-card">
        ...
        {car.hasAccidentHistory && (
          <p className="detail-accident-note">
            <strong>
              Accident history:
            </strong>{' '}
            {car.accidentNotes ||
      ...
      <section className="detail-message-card">
        <h3>
