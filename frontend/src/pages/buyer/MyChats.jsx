...
export default function MyChats() {
  ...
  useEffect(() => {
    ...
    const conversation = conversations.find(
      (item) =>
        chatId(item) ===
        chatId(requestedConversationId)
    );
    ...
    // Consume this navigation before opening:
    // read/live updates must not reopen it.
    openedNavigation.current = location.key;
      ...
      <div className="chat-sidebar">
        ...
        {conversations.length === 0 && (
          <p className="chat-empty-note">
            ...
            <br />
            Message a seller from a car&apos;s detail page.
          </p>
        )}
        ...
        {conversations.map((convo) => (
          <div
            ...
            className={`chat-convo-item chat-delete-item ${
          ...
          >
            ...
            <div className="chat-convo-info">
              <div className="chat-convo-name">
                {sellerLabel(convo)}
              </div>

              <div className="chat-convo-car">
                {convo.car?.makeModel}
              </div>
