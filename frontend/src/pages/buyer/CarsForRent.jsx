    ...
    <>
      ...
      <main className="rental-page">
        <div className="rental-heading">
          ...
          <p>
            Explore active rental vehicles from trusted sellers.
          </p>
        </div>
        ...
        >
          ...
          <label className="rental-driver-filter">
            <input
        ...
        <p className="rental-count">
          {loading
            ? 'Loading rentals...'
            : `${rentals.length} rental cars available`}
        </p>
        ...
        <div className="car-grid">
          ...
          {rentals.map((rental) => (
            <article
              className="car-card rental-card"
              key={rental._id}
            >
              <div className="car-img-wrap">
                {rental.images?.[0] ? (
                  <img
                    src={imageUrl(rental.images[0])}
              ...
              <p>
                {rental.city} · {rental.transmission} ·{' '}
                {rental.seats} seats
              </p>
